...
class QuestionsViewController: UIViewController {
    ...
    func updateUI(){
        ...
        let currentAswers = currentQuestion.answers
        ...
        case .single:
            updateSingleStack(using: currentAswers)
        case .multiple:
            updateMultipleStack(using: currentAswers)
        case .ranged:
            updateRangedStack(using: currentAswers)
        }
